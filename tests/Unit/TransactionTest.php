...
class TransactionTest extends TestCase
{
    ...
    public function test_トランザクション件数のテスト()
    {
        ...
        $transaction = $channel->transactions()->updateOrCreate(
            ['date' => $yesterday2],
            ['view_count' => 50, 'subscriber_count' => 5]
        );
        ...
        $transaction = $channel->transactions()->updateOrCreate(
            ['date' => $yesterday2],
            ['view_count' => 100, 'subscriber_count' => 10]
        );
        ...
        $transaction = $channel->transactions()->updateOrCreate(
            ['date' => $yesterday1],
            ['view_count' => 150, 'subscriber_count' => 15]
        );
        ...
        $transaction = $channel->transactions()->updateOrCreate(
            ['date' => $yesterday1],
            ['view_count' => 200, 'subscriber_count' => 20]
        );
        ...
        $transaction = $channel->transactions()->updateOrCreate(
            ['date' => $today],
            ['view_count' => 400, 'subscriber_count' => 40]
        );
